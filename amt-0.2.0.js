        ...
        if (eventSensorType == 15) {
            ...
            if (eventOffset == 0) {
                ...
                if (eventDataField[0]==170 && eventDataField[1]==48) {
                    return "AMT One Click Recovery: "+ _OCRErrorEvents[eventDataField[2]];
                } else {
                ...
                if (eventDataField[0]==170 && eventDataField[1]==48) {					
                    if (eventDataField[2]==1) {
                        return "AMT One Click Recovery: CSME Boot Option "+(eventDataField[3])+":"+_OCRSource[(eventDataField[3])]+" added successfully";						
                    } else if (eventDataField[2]<7 ) {
                        return "AMT One Click Recovery: "+ _OCRProgressEvents[eventDataField[2]];
                    } else {
                        return "AMT One Click Recovery: unknown progress event "+ eventDataField[2]
                    }
                } else {
